...
namespace Collaborative.Infra.Migrations
{
    ...
    [Migration("20200910012942_Initial")]
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Collaborative", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 9, 22, 29, 42, 532, DateTimeKind.Local).AddTicks(775));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Collaborator", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 9, 22, 29, 42, 532, DateTimeKind.Local).AddTicks(1709));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.FinancialAccount", b =>
                {
                    ...
                    b.Property<DateTime>("Open")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 9, 22, 29, 42, 532, DateTimeKind.Local).AddTicks(2818));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("Ordered")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 9, 22, 29, 42, 532, DateTimeKind.Local).AddTicks(3630));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 9, 22, 29, 42, 532, DateTimeKind.Local).AddTicks(6541));
