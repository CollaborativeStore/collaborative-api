...
namespace Collaborative.Infra.Migrations
{
    ...
    [Migration("20200915192133_RefactoringCollaborativeTable")]
    partial class RefactoringCollaborativeTable
    {
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Collaborative", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 15, 16, 21, 33, 486, DateTimeKind.Local).AddTicks(7109));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Collaborator", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 15, 16, 21, 33, 486, DateTimeKind.Local).AddTicks(8164));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.FinancialAccount", b =>
                {
                    ...
                    b.Property<DateTime>("Open")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 15, 16, 21, 33, 486, DateTimeKind.Local).AddTicks(9350));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("Ordered")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 15, 16, 21, 33, 487, DateTimeKind.Local).AddTicks(341));
            ...
            modelBuilder.Entity("Collaborative.Domain.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2020, 9, 15, 16, 21, 33, 487, DateTimeKind.Local).AddTicks(6241));
